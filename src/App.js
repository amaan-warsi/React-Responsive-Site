...
import team from './img/team/team-4.jpg';
...
function App() {
  return (
      <><header id="header" class="fixed-top ">
        ...
        <h1 class="logo me-auto"><a href="index.html">React Site</a></h1>
      ...
      <div class="container" >
        ...
        <div class="row portfolio-container" >
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <img class="img-fluid" alt="" src={portfolio1} />
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" >
            <div class="member d-flex align-items-start">
              <div class="pic"><img src={team} class="img-fluid" alt="" /></div>
    ...
    <section id="contact" class="contact">
      <div class="container" >
        ...
        <div align="center">© 2023 Copyright Simple React Site. All Rights Reserved </div>
<br></br>
      </> 
